...
exports = ___CSS_LOADER_API_IMPORT___(true);
// Module
exports.push([module.i, "@charset \"UTF-8\";\n/**\n * @copyright chuzhixin 1204505056@qq.com\n * @description 全局主题变量配置\n */\n/* stylelint-disable */\n[data-v-cf51e862]:export {\n  menu-color: rgba(255, 255, 255, 0.95);\n  menu-color-active: rgba(255, 255, 255, 0.95);\n  menu-background: #001529;\n  menu-background-active: #1890ff;\n  tags-bar-background-active: #1890ff;\n  button-background: #1890ff;\n  pagination-background-active: #1890ff;\n}\n.message-title[data-v-cf51e862] {\n  padding-right: 8px;\n  font-size: 16px;\n  color: #333;\n}\n[data-v-cf51e862] .el-badge__content {\n  top: 1px !important;\n  line-height: 14px !important;\n}", "",{"version":3,"sources":["D:/Development/WebStormProjects/vue-admin-beautiful/src/components/ErrorLog/index.vue","D:/Development/WebStormProjects/vue-admin-beautiful/src/components/ErrorLog/D:/Development/WebStormProjects/vue-admin-beautiful/src/styles/variables.scss","D:/Development/WebStormProjects/vue-admin-beautiful/src/components/ErrorLog/D:/Development/WebStormProjects/vue-admin-beautiful/src/components/ErrorLog/index.vue"],"names":[],"mappings":"AAAA,gBAAgB;ACAhB;;;EAAA;AAIA,sBAAA;AAiDA;EACE,qCA1CgB;EA2ChB,4CA1CuB;EA2CvB,wBA9CqB;EA+CrB,+BAlDmB;EAmDnB,mCAnDmB;EAoDnB,0BApDmB;EAqDnB,qCArDmB;ADOrB;AEyGA;EACE,kBAAA;EACA,eAAA;EACA,WAAA;AFtGF;AE0GE;EACE,mBAAA;EACA,4BAAA;AFvGJ","file":"index.vue","sourcesContent":["@charset \"UTF-8\";\n/**\n * @copyright chuzhixin 1204505056@qq.com\n * @description 全局主题变量配置\n */\n/* stylelint-disable */\n:export {\n  menu-color: rgba(255, 255, 255, 0.95);\n  menu-color-active: rgba(255, 255, 255, 0.95);\n  menu-background: #001529;\n  menu-background-active: #1890ff;\n  tags-bar-background-active: #1890ff;\n  button-background: #1890ff;\n  pagination-background-active: #1890ff;\n}\n\n.message-title {\n  padding-right: 8px;\n  font-size: 16px;\n  color: #333;\n}\n\n::v-deep .el-badge__content {\n  top: 1px !important;\n  line-height: 14px !important;\n}","/**\n * @copyright chuzhixin 1204505056@qq.com\n * @description 全局主题变量配置\n */\n/* stylelint-disable */\n@charset \"utf-8\";\n\n$base-color-default: #1890ff;\n$base-z-index: 999;\n\n$base-menu-background: #001529;\n$base-menu-background-active: $base-color-default;\n$base-menu-color: hsla(0, 0%, 100%, 0.95);\n$base-menu-color-active: hsla(0, 0%, 100%, 0.95);\n$base-title-color: #fff;\n\n$base-font-size-small: 12px;\n$base-font-size-default: 14px;\n$base-font-size-big: 16px;\n$base-font-size-bigger: 18px;\n$base-font-size-max: 22px;\n$base-color-header: $base-menu-background;\n$base-color-blue: $base-color-default;\n$base-color-green: #13ce66;\n$base-color-white: #fff;\n$base-color-black: #000;\n$base-color-yellow: #ffba00;\n$base-color-orange: #ff6700;\n$base-color-red: #ff4d4f;\n$base-color-gray: rgba(0, 0, 0, 0.65);\n$base-main-width: 1279px;\n$base-border-radius: 2px;\n$base-border-color: #dcdfe6;\n$base-form-width: 600px;\n$base-input-height: 32px;\n$base-padding: 20px;\n$base-box-shadow: 0 1px 4px rgba(0, 21, 41, 0.08);\n$base-font-color: #606266;\n$base-top-bar-height: 70px;\n$base-nav-bar-height: 55px;\n$base-tags-bar-height: 55px;\n$base-menu-item-height: 50px;\n$base-tag-item-height: 34px;\n$base-app-main-height: calc(\n  100vh - #{$base-nav-bar-height} - #{$base-tags-bar-height} - #{$base-padding} -\n  #{$base-padding} - 55px\n);\n$base-left-menu-width: 220px;\n$base-right-content-width: calc(100% - #{$base-left-menu-width});\n$base-left-menu-width-min: 65px;\n$base-right-content-width-min: calc(100% - #{$base-left-menu-width-min});\n$base-transition: all 0.3s;\n\n:export {\n  menu-color: $base-menu-color;\n  menu-color-active: $base-menu-color-active;\n  menu-background: $base-menu-background;\n  menu-background-active: $base-menu-background-active;\n  tags-bar-background-active: $base-color-blue;\n  button-background: $base-color-blue;\n  pagination-background-active: $base-color-blue;\n}\n","@import \"~@/styles/variables.scss\";\r\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n.message-title {\n  padding-right: 8px;\n  font-size: 16px;\n  color: #333;\n}\n\n::v-deep {\n  .el-badge__content {\n    top: 1px !important;\n    line-height: 14px !important;\n  }\n}\n"]}]);
// Exports
module.exports = exports;
